...
function edd_bbp_d_register_admin_settings() {
	...
	add_settings_field( '_bbps_used_status_2', __( 'Display Status:', 'pojo-bbpress-support' ), 'edd_bbp_d_admin_setting_callback_displayed_status_notres', 'bbpress', 'bbps-status-setting' );
